...
public class MyCharacterController : MonoBehaviour
{
    ...
    //przyciski sterowania na telefonie
    ...
    void Start()
    {
        ...
        //ForwardButton = GetComponent<GameObject>();
        //BackwardButton = GetComponent<GameObject>();
    ...
    {
        //Skakanie
        if ((characterControler.isGrounded && Input.GetButton("Jump")) || (characterControler.isGrounded && JumpButton))
        {
